 ...
 *         2015-3-5
 */
public class ViewWa extends View {
     ...
     * @param attrs
     */
    public ViewWa(Context context, AttributeSet attrs) {
     ...
     * @param defStyle
     */
    public ViewWa(Context context, AttributeSet attrs, int defStyle) {
    ...
    private void init(Context context, AttributeSet attrs) {
        ...
        TypedArray a = context.obtainStyledAttributes(attrs, R.styleable.ViewWa);
        int color_tianchong = a.getColor(R.styleable.WaDrColor,Color.parseColor("#ffc9394a"));
        // 初始化画笔
        paint = new Paint();
        ...
        // 获得资源文件
        bitmap = BitmapFactory.decodeResource(getResources(), R.mipmap.logo_white);
        // 设置宽高为图片的宽高
